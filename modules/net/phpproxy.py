...
class Phpproxy(ModuleProbe):
    ...
    def _prepare_probe(self):
        ...
        if self.args['install']:
            ...
            self._check_web_root_folder(install_folder)
            ...
            self._check_web_root_folder(self.args['find'])
